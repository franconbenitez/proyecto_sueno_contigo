                ...
                <div class="card-auth">
                    ...
                    <div class="d-flex flex-column gap-2 mb-4">
                        ...
                        <a href="#" class="btn-social">
                            <svg class="icono-social" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    ...
                    {{-- Link a registro --}}
                    <p class="text-center auth-pie">
                        ¿No tenés cuenta?
                        <a href="/registro" class="link-auth">Registrate acá</a>
                    </p>
